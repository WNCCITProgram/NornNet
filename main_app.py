...
def hello():
    ...
    # This should load previous chat logs
    robot.load_memory()
...
"""
    Joe Scott 11/12/2025: I FOUND THE BUG 
       ...
       - Website ==> Flask(..., static_url_path='/nornnet/static')
       - Local   ==> Flask(..., static_url_path='/static')

       This issue also persists on the line 108 in index.html
...
"""
app = Flask(__name__, static_folder='static', static_url_path='/nornet/static')
